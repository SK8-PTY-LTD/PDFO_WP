...
if (!class_exists('Essential_Real_Estate')) {
    ...
    class Essential_Real_Estate
    {
        ...
        private function admin_hooks()
        {
            ...
            $this->loader->add_filter('ere_property_label_slug', $property_admin, 'modify_property_label_slug');
            // Agent Post Type
            $agent_admin = new ERE_Agent_Admin();
            $this->loader->add_filter('ere_agent_slug', $agent_admin, 'modify_agent_slug');
            $this->loader->add_filter('ere_agency_slug', $agent_admin, 'modify_agency_slug');
            $this->loader->add_filter('init', $agent_admin, 'modify_author_slug');
            ...
            if (is_admin()) {
                ...
                if ($pagenow == 'edit.php' && isset($_GET['post_type']) && esc_attr($_GET['post_type']) == 'property') {
                    ...
                    $this->loader->add_filter('request', $property_admin, 'column_orderby');
                ...
                if ($pagenow == 'edit.php' && isset($_GET['post_type']) && esc_attr($_GET['post_type']) == 'package') {
                    ...
                    $this->loader->add_filter('post_row_actions', $package_admin, 'modify_list_row_actions',10,2);
                }
                ...
                if ($pagenow == 'edit.php' && isset($_GET['post_type']) && esc_attr($_GET['post_type']) == 'user_package') {
                    ...
                    $this->loader->add_filter('post_row_actions', $user_package_admin, 'modify_list_row_actions',10,2);
                }
                ...
                if ($pagenow == 'edit.php' && isset($_GET['post_type']) && esc_attr($_GET['post_type']) == 'invoice') {
                    ...
                    $this->loader->add_filter('request', $invoice_admin, 'column_orderby');
                    $this->loader->add_filter('post_row_actions', $invoice_admin, 'modify_list_row_actions',10,2);
                }
                ...
                if ($pagenow == 'edit.php' && isset($_GET['post_type']) && esc_attr($_GET['post_type']) == 'trans_log') {
                    ...
                    $this->loader->add_filter('request', $trans_log_admin, 'column_orderby');
                    $this->loader->add_filter('post_row_actions', $trans_log_admin, 'modify_list_row_actions',10,2);
                }
