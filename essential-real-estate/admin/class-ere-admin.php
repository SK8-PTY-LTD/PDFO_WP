...
if (!class_exists('ERE_Admin')) {
    ...
    class ERE_Admin
    {
            ...
            $configs['property_meta_boxes'] = array(
                ...
                'section' => array(
                    ...
                    array(
                        ...
                        'fields' => ere_render_additional_fields()
                    ),
                    array(
        ...
        public function register_taxonomy($taxonomies)
        {
            ...
            $taxonomies['property-label'] = array(
                'post_type' => 'property',
            ...
            <div id="taxonomy-<?php echo esc_attr($taxonomy); ?>" class="selectdiv ere-property-select-meta-box-wrap">
                <?php if (current_user_can($tax->cap->edit_terms)): ?>
                    ...
                    if ($hierarchical) {
                        ...
                        ?>
                        <select name="<?php echo "tax_input[$taxonomy][]"; ?>" class="<?php echo esc_attr($class); ?>" data-selected="<?php echo ere_get_taxonomy_slug_by_post_id($post->ID, $taxonomy);?>">
        ...
        public function register_term_meta($configs)
        {
            ...
            $configs['property-label-settings'] = array(
                'name' => esc_html__('Taxonomy Setting', 'essential-real-estate'),
                'layout' => 'horizontal',
                ...
                'fields' => array_merge(
                    ...
                    array(
                        ...
                        array(
                            ...
                            'subtitle' => esc_html__('Choose Measurement units.', 'essential-real-estate'),
                            'options' => array(
                ...
                'fields' => array_merge(
                    ...
                    array(
                        array(
                            ...
                            'title' => esc_html__('Main Option', 'essential-real-estate'),
                            'type' => 'group',
                            'fields' => array(
                                array(
                                    'id' => 'auto_publish',
...
The invoice number is: %invoice_no', 'essential-real-estate'),
                        ...
                        array(
                            'id' => 'email-new-submission_listing',
...
Listing ID:  %listing_id', 'essential-real-estate'),
                        ...
                        array(
                            'id' => 'email-new-modification_listing',
