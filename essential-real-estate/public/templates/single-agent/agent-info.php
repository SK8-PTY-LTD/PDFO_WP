    ...
    <div class="agent-single-inner row">
        ...
        <div class="agent-content col-md-5 col-sm-12">
            <div class="agent-content-top agent-title">
                <?php if (!empty($agent_name)): ?>
                    <h2 class="fs-32 fw-semi-bold heading-color"><?php echo esc_html($agent_name) ?></h2>
                <?php endif; ?>
                ...
                <?php endif; ?>
                <span class="fs-16 fw-medium btn-block accent-color">
            ...
            <div class="agent-contact agent-info">
                <?php if (!empty($agent_office_address)): ?>
                    <div><i class="fa fa-map-marker accent-color"></i><strong><?php esc_html_e('Address:', 'essential-real-estate'); ?></strong>
							<span><?php echo esc_html($agent_office_address) ?></span>
                    </div>
                <?php endif; ?>
                <?php if (!empty($email)): ?>
                    <div><i class="fa fa-envelope accent-color"></i><strong><?php esc_html_e('Email:', 'essential-real-estate'); ?></strong>
                ...
                <?php if (!empty($agent_mobile_number)): ?>
                    <div>
                        <i class="fa fa-phone accent-color"></i><strong><?php esc_html_e('Phone:', 'essential-real-estate'); ?></strong>
                        <span><?php echo esc_html($agent_mobile_number) ?></span>
                    </div>
                <?php endif; ?>
                <?php if (!empty($agent_website_url)): ?>
                    <div>
                        <i class="fa fa-link accent-color"></i><strong><?php esc_html_e('Website:', 'essential-real-estate'); ?></strong>
                ...
                <hr class="mg-top-20">
                <?php
                $agencies =  wp_get_post_terms( get_the_id(), 'agency');
                if(count($agencies)>0){?>
        ...
        <div class="contact-agent col-md-4 col-sm-12">
            <div class="contact-agent-title">
                <h4 class="uppercase fw-semi-bold fs-18 mg-bottom-20"><?php esc_html_e('Contact', 'essential-real-estate'); ?></h4>
            </div>
        ...
        <?php if (!empty($agent_description)): ?>
            <div class="col-md-12 mg-top-40 mg-bottom-40">
                <p class="fs-14 line-2x"><?php echo esc_html($agent_description) ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>