...
if(!is_user_logged_in()):?>
    <a href="javascript:void(0)" class="login-link topbar-link" data-toggle="modal" data-target="#ere_signin_modal"><i class="fa fa-user accent-color"></i><span class="hidden-xs"><?php esc_html_e('Login or Register','essential-real-estate') ?></span></a>
<?php else:
    global $current_user;
    wp_get_current_user();
    ...
    <div class="user-dropdown">
        <span class="user-display-name"><i class="fa fa-user accent-color"></i><span class="hidden-xs"><?php echo esc_html($user_login); ?></span></span>
            ...
            if ($allow_submit) :
                ...
                if ($permalink = ere_get_permalink('submit_property')) : ?>
                    <li class="list-group-item">
                        <a href="<?php echo esc_url($permalink); ?>"><i class="fa fa-plus-circle accent-color"></i><?php esc_html_e('Submit New Property', 'essential-real-estate'); ?></a></li>
                <?php endif;
            endif;
