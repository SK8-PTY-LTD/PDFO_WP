...
<a href="javascript:void(0)" class="property-favorite" data-property-id="<?php echo intval($property_id) ?>"
   data-toggle="tooltip"
   title="<?php echo($title) ?>" data-title-not-favorite="<?php esc_attr_e('Add to Favorite', 'essential-real-estate') ?>" data-title-favorited="<?php esc_attr_e('It is my favorite', 'essential-real-estate'); ?>"><i
