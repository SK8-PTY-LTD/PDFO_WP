...
<div class="ere-sliderbar-price-wrap <?php echo esc_attr($css_class_field); ?> form-group">
    ...
    <div class="ere-sliderbar-price ere-sliderbar-filter"
        ...
        <div class="title-slider-filter">
            <?php esc_html_e('Price', 'essential-real-estate') ?> <?php echo ere_get_option('currency_sign'); ?> [<span
                class="min-value"><?php echo ere_get_format_number($min_price_change) ?></span> - <span
                class="max-value"><?php echo ere_get_format_number($max_price_change) ?></span>]
