            ...
            <div class="<?php echo join(' ', $property_content_class) ?>">
                ...
                <?php if ($data->have_posts()) :
                    ...
                    while ($data->have_posts()): $data->the_post();
                        ...
                        $property_iterm_featured = isset($property_meta_data[ERE_METABOX_PREFIX . 'property_featured']) ? $property_meta_data[ERE_METABOX_PREFIX . 'property_featured'][0] : '0';
                        ...
                        $property_iterm_lable = get_the_terms(get_the_ID(), 'property-label');
                        ...
                        <div class="<?php echo join(' ', $property_item_class); ?>">
                            <div class="property-inner">
                                <div class="property-image <?php echo join(' ', $property_avatar_class); ?>">
                                    ...
                                    <?php if ($property_iterm_lable || $property_iterm_featured): ?>
                                        <div class="property-label property-featured">
                                            <?php if ($property_iterm_featured): ?>
                                                <p class="label-item">
                                                    <span
                                            ...
                                            <?php endif; ?>
                                            <?php if ($property_iterm_lable): ?>
                                                <?php foreach ($property_iterm_lable as $label_item): ?>
                                ...
                                <div
                                    ...
                                    <?php if ($property_iterm_type && $layout_style != 'property-zigzac'): ?>
