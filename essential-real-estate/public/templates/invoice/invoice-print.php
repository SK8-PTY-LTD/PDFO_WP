...
print  '<link href="' . ERE_PLUGIN_URL . '/public/assets/css/single-invoice.css" rel="stylesheet" type="text/css" />';
print  '<link href="' . ERE_PLUGIN_URL . '/public/assets/packages/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />';

if( $isRTL == 'true' ) {
	print '<link href="'.ERE_PLUGIN_URL.'/public/assets/css/invoice-print-rtl.css" rel="stylesheet" type="text/css" />';
}
print '</head>';
...
<div class="single-invoice-wrap">
	...
	<div class="invoice-info pull-right">
		<p class="invoice-id mg-bottom-10">
			<span class="fw-bold"><?php esc_html_e( 'Invoice ID: ', 'essential-real-estate' ); ?></span>
			<?php echo esc_html( $invoice_id ); ?>
		</p>
		<p class="invoice-date">
			<span class="fw-bold"><?php esc_html_e( 'Date: ', 'essential-real-estate' ); ?></span>
	...
	<div class="agent-info">
		<div class="agent-main-info pull-left">
			<p class="fw-bold mg-bottom-10"><?php esc_html_e( 'To:', 'essential-real-estate' ) ?></p>
			<?php if(!empty( $agent_name )): ?>
				<div class="full-name">
					<span class="fw-medium"><?php esc_html_e( 'Full name: ', 'essential-real-estate' ) ?></span>
					<?php echo esc_html( $agent_name ); ?>
				</div>
			<?php endif; ?>
			<?php if(!empty( $agent_email )): ?>
				<div class="agent-email">
					<span class="fw-medium"><?php esc_html_e( 'Email: ', 'essential-real-estate' ) ?></span>
					<?php echo esc_html( $agent_email ); ?>
				</div>
			<?php endif; ?>
		</div>
		<div class="agent-company-info pull-right">
			<p class="fw-bold mg-bottom-10"><?php esc_html_e( 'From:', 'essential-real-estate' ) ?></p>
			<?php if(!empty( $company_name )): ?>
				<div class="company-name">
					<span class="fw-medium"><?php esc_html_e( 'Company Name: ', 'essential-real-estate' ) ?></span>
					<?php echo esc_html( $company_name ); ?>
				</div>
			<?php endif; ?>
			<?php if(!empty( $company_address )): ?>
				<div class="company-address">
					<span class="fw-medium"><?php esc_html_e( 'Company Address: ', 'essential-real-estate' ) ?></span>
					<?php echo esc_html( $company_address ); ?>
				</div>
			<?php endif; ?>
			<?php if(!empty( $company_phone )): ?>
				<div class="company-phone">
					<span class="fw-medium"><?php esc_html_e( 'Phone: ', 'essential-real-estate' ) ?></span>
	...
	<div class="billing-info">
		<table>
			<tbody>
				<tr>
					<th class="text-left"><?php esc_html_e( 'Item Name:', 'essential-real-estate' ); ?></th>
					<td class="text-right"><?php echo esc_html( $item_name ); ?></td>
				</tr>
				<tr>
					<th class="text-left"><?php esc_html_e( 'Payment Type:', 'essential-real-estate' ); ?></th>
					<td class="text-right"><?php echo esc_html( $payment_type ); ?></td>
				</tr>
				<tr>
					<th class="text-left"><?php esc_html_e( 'Payment Method:', 'essential-real-estate' ); ?></th>
					<td class="text-right"><?php echo esc_html( $payment_method ); ?></td>
				</tr>
				<tr>
					<th class="text-left"><?php esc_html_e( 'Total Price:', 'essential-real-estate' ); ?></th>
					<td class="accent-color fw-bold text-right"><?php echo esc_html( $total_price ); ?></td>
				</tr>
			</tbody>
		</table>
	</div>
