...
<?php endif; ?>
    <div class="agency-content-top agency-title mg-bottom-25">
        <?php if (!empty($agency_term->name)): ?>
            <h2 class="fs-32 fw-semi-bold heading-color mg-bottom-10"><?php echo esc_html($agency_term->name) ?></h2>
        <?php endif; ?>
    ...
    <div class="agency-data fw-medium mg-bottom-30">
        <div class="agency-data-item agency-data-property">
                    <span class="agency-data-item-title accent-color"><?php esc_html_e('Properties', 'essential-real-estate'); ?>: </span>
        ...
        <div class="agency-info">
            <?php if (!empty($agency_office_number)): ?>
                <div class="agency-info-item agency-office-number">
                    <i class="fa fa-phone accent-color"></i><strong class="agency-info-title"><?php esc_html_e('Phone', 'essential-real-estate') ?>: </strong>
            ...
            <?php if (!empty($agency_mobile_number)): ?>
                <div class="agency-info-item agency-mobile-number">
                    <i class="fa fa-mobile-phone accent-color"></i><strong class="agency-info-title"><?php esc_html_e('Mobile', 'essential-real-estate') ?>: </strong>
            ...
            <?php if (!empty($agency_fax_number)): ?>
                <div class="agency-info-item agency-fax-number">
                    <i class="fa fa-print accent-color"></i><strong class="agency-info-title"><?php esc_html_e('Fax', 'essential-real-estate') ?>: </strong>
            ...
            <?php if (!empty($agency_website_url)): ?>
                <div class="agency-info-item agency-website">
                    <i class="fa fa-external-link-square accent-color"></i><strong class="agency-info-title"><?php esc_html_e('Website', 'essential-real-estate') ?>: </strong>
            ...
            <?php if (!empty($agency_email)): ?>
                <div class="agency-info-item agency-email">
                    <i class="fa fa-envelope accent-color"></i><strong class="agency-info-title"><?php esc_html_e('Email', 'essential-real-estate') ?>: </strong>
    ...
    <div class="contact-agency col-md-4 col-sm-12 sm-pd-top-60">
        <div class="contact-agency-title">
            <h4 class="uppercase fw-semi-bold fs-18 mg-bottom-30"><i
                    class="icon-mail-envelope-open6 accent-color"></i> <?php esc_html_e('Contact Agency', 'essential-real-estate'); ?>
            </h4>
        </div>
