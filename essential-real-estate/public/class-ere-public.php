...
if (!class_exists('ERE_Public')) {
    ...
    class ERE_Public
    {
        ...
        {
            require_once ERE_PLUGIN_DIR . 'public/partials/ere-partials.php';
        ...
        public function enqueue_styles()
        {
            ...
            wp_enqueue_style('bootstrap', ERE_PLUGIN_URL . 'public/assets/packages/bootstrap/css/bootstrap.min.css', array(), '3.3.7', 'all');
            ...
            wp_enqueue_style('font-awesome', ERE_PLUGIN_URL . 'public/assets/packages/fonts-awesome/css/font-awesome.min.css', array(), '4.7.0', 'all');
        ...
        public function enqueue_scripts()
        {
            ...
            wp_enqueue_script('bootstrap', ERE_PLUGIN_URL . 'public/assets/packages/bootstrap/js/bootstrap.min.js', array('jquery'), '3.3.7', true);
            ...
            $googlemap_api_key = ere_get_option('googlemap_api_key','AIzaSyBOSS6pPg5w08pt73WZrLp4sdRv_b956vQ');
            ...
            wp_localize_script(ERE_PLUGIN_PREFIX . 'compare', 'ere_compare_vars',
                array(
					...
					'alert_message' => esc_html__('Just Compare 4 Elements!', 'essential-real-estate'),
            ...
            $user_profile_data = array(
                ...
                'confirm_become_agent_msg' => 'Click to accept <a href="/agents-terms-and-conditions/" target="_blank">Terms and Conditions.</a>',
