 ...
 * *******************************************************
 */
if (!function_exists('gf_get_less_to_css_editor')) {
    function gf_get_less_to_css_editor($compress = false)
    {
        $css_variable = gf_get_custom_css_variable();
        ...
        // Parse style.less
        $parser->parseFile(trailingslashit(get_template_directory()) . 'assets/less/editor-style.less', trailingslashit(get_template_directory_uri()));
 ...
 * *******************************************************
 */
if (!function_exists('gf_get_less_to_css_editor_blocks')) {
    function gf_get_less_to_css_editor_blocks($compress = false)
    {
        $css_variable = gf_get_custom_css_variable();
        ...
        // Parse style.less
        $parser->parseFile(trailingslashit(get_template_directory()) . 'assets/less/editor-blocks.less', trailingslashit(get_template_directory_uri()));
    ...
    function gf_generate_less($preset_id = 0)
    {
        ...
        try {
            ...
            if (!$wp_filesystem->put_contents($dir_css['style'] . "style.min.css", $css, FS_CHMOD_FILE)) {
                ...
                return array(
                    'status'  => 'error',
                    'message' => esc_html__('Could not save file', 'beyot-framework')
                );
            }
            ...
            //////////////////////////////////////////////////////////////////
            // Gen File editor-style
            //////////////////////////////////////////////////////////////////
            $css = gf_get_less_to_css_editor();
            if (!$wp_filesystem->put_contents($dir_css['other'] . "editor-style.css", $css, FS_CHMOD_FILE)) {
                if ($preset_id) {
                    $GLOBALS[GF_OPTIONS_NAME] = $options;
                }
                return array(
            ...
            // Gen File editor-style
            //////////////////////////////////////////////////////////////////
            $css = gf_get_less_to_css_editor_blocks();
            if (!$wp_filesystem->put_contents($dir_css['other'] . "editor-blocks.css", $css, FS_CHMOD_FILE)) {
                if ($preset_id) {
                    $GLOBALS[GF_OPTIONS_NAME] = $options;
                }
                return array(
